...
const koreanFood = (userId) => __awaiter(this, void 0, void 0, function* () {
    const carousel = {
        type: "template",
...
const chineseFood = (userId) => __awaiter(this, void 0, void 0, function* () {
    const carousel = {
        type: "template",
        altText: "this is a carousel template",
        template: {
...
const chineseFood1 = (userId) => __awaiter(this, void 0, void 0, function* () {
    let columns = [
        {
            thumbnailImageUrl: "https://firebasestorage.googleapis.com/v0/b/ezcook-203202.appspot.com/o/%E8%82%89%E7%87%A5%E9%A3%AF.PNG?alt=media&token=6278e6bb-b916-4534-b29b-377a003522b7",
            text: "肉燥飯",
...
const chineseFood2 = (userId) => __awaiter(this, void 0, void 0, function* () {
    let textMessage = {
        type: "text",
        text: "請輸入食材( 請已全型逗號分隔 )"
    };
...
const chineseFood2fallback = (userId, resolvedQuery) => __awaiter(this, void 0, void 0, function* () {
...
const japaneseFood = (userId) => __awaiter(this, void 0, void 0, function* () {
    const carousel = {
        type: "template",
        altText: "this is a carousel template",
        template: {
...
const chefChoose = (userId) => __awaiter(this, void 0, void 0, function* () {
    const chefs = yield chefService.getChefs();
    let columns = [];
    chefs.forEach(chef => {
...
const foodPlanning = (userId) => __awaiter(this, void 0, void 0, function* () {
    const textMessage = {
        type: "text",
        text: "功能善未完善，敬請期待"
    };
...
const recipeCooking = (userId) => __awaiter(this, void 0, void 0, function* () {
    let columns = [];
    columns.push({
        title: "《ezCook》",
        text: `中式食譜`,
...
const demonFood = (userId) => __awaiter(this, void 0, void 0, function* () {
    const videoMessage = {
        type: "video",
...
const onlineShopping = (userId) => __awaiter(this, void 0, void 0, function* () {
    const textMessage = {
        type: "text",
        text: "功能善未完善，敬請期待"
    };
...
const systemConfig = (userId) => __awaiter(this, void 0, void 0, function* () {
    const textMessage = {
        type: "text",
        text: "功能善未完善，敬請期待"
    };
...
const contact = (userId, chefId) => __awaiter(this, void 0, void 0, function* () {
    const member = yield memberService.getMemberByLineId(userId);
    const chef = yield chefService.getChefByLineId(chefId);
...
const correct = (chefId, memberId) => __awaiter(this, void 0, void 0, function* () {
    const chef = yield chefService.getChefByLineId(chefId);
    const member = yield memberService.getMemberByLineId(memberId);
    const textChefMessage = {
        type: "text",
        text: `目前已開啟1對1交談模式\n請慎言\n\n目前交談對象 : ${member.name}`
    };
...
const refuse = (chefId, memberId) => __awaiter(this, void 0, void 0, function* () {
    const chef = yield chefService.getChefByLineId(chefId);
    const member = yield memberService.getMemberByLineId(memberId);
    const textMessage = {
        type: "text",
...
const introduction = (userId, text) => {
...
const postbackDispatcher = (userId, postbackData) => {
...
const followMessage = (replyToken, userId) => __awaiter(this, void 0, void 0, function* () {
    const imageMap = {
        type: "imagemap",
    ...
    yield replyMessage(replyToken, [imageMap, buttonsMessage]);
});
...
exports.checkEmail = functions.https.onRequest((req, res) => __awaiter(this, void 0, void 0, function* () {
    const email = req.query.email;
    console.log("email", email);
    yield memberService.checkMemberByEmail(email);
